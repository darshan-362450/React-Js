    ...
    <div className="absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between">
      ...
      <div>
        <p className="text-xl leading-relaxed text-white mb-14">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae nam et
          magnam, ad vitae similique.
        </p>
        <div className="flex justify-between">
          <button className="bg-blue-600 text-white font-medium px-7 py-2 rounded-full  ">
           {props.tag}
          </button>
